        ...
        columns:[
                ...
                }},
            {
                ...
                "render": function (id, row, type, set) {
                    ...
                    var viewButton =`<a href="/users/view/${type.user_id}" class="btn btn-icon btn-custom btn-light btn-sm btn-active-light btn-active-color-primary">
                    ...
                    var editButton = `<a href="/users/edit/${type.user_id}" class="btn btn-icon btn-custom btn-light btn-sm btn-active-light btn-active-color-primary mx-3">
                    ...
                    var deleteButton = `<a href="javascript:void(0);" class="btn btn-icon btn-custom btn-light btn-sm btn-active-light btn-active-color-primary userDeleteButton" data-id="${type.user_id}">
