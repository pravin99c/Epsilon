            ...
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                        class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2 {{ strpos(Route::currentRouteName(), 'roles') === 0 ? 'here show' : '' }} {{ strpos(Route::currentRouteName(), 'permissions') === 0 ? 'here show' : '' }}">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                        ...
                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
                            @can('Role list')
                                <!--begin:Menu item-->
                                <div class="menu-item {{ strpos(Route::currentRouteName(), 'roles') === 0 ? 'here menu-here-bg' : '' }}">
                                    <!--begin:Menu link-->
                            ...
                            @can('Permission list')
                                <!--begin:Menu item-->
                                <div class="menu-item {{ strpos(Route::currentRouteName(), 'permissions') === 0 ? 'here menu-here-bg' : '' }}">
                                    <!--begin:Menu link-->
                    ...
                    @can('User list')
                        <a href="{{ route('users.view') }}"
                            class="menu-item {{ strpos(Route::currentRouteName(), 'users') === 0 ? 'here show' : '' }} menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
                            <!--begin:Menu link-->
                            <span class="menu-link">
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-3">
                    ...
                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px position-relative"
                        ...
                        <span
                            class="bullet bullet-dot bg-transparent h-6px w-6px position-absolute translate-middle top-0 start-50"
                            id="notify-bullet"></span>
                    </div>
