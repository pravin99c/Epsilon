            ...
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                    ...
                    <a href="{{ route('dashboard') }}"
                        class="menu-item {{ Route::currentRouteName() ==  'dashboard' ? 'here show' : ''}} menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
                        <!--begin:Menu link-->
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                        ...
                        class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2 {{ Route::currentRouteName() ==  'roles.view' ? 'here show' : ''}} {{ Route::currentRouteName() ==  'permissions.view' ? 'here show' : ''}}">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                        ...
                        <div
                            ...
                            <!--begin:Menu item-->
                            <div class="menu-item {{ Route::currentRouteName() == 'roles.view' ? 'here menu-here-bg' : '' }}">
                                <!--begin:Menu link-->
                            ...
                            <!--end:Menu item-->
                             <!--begin:Menu item-->
                             <div class="menu-item {{ Route::currentRouteName() == 'permissions.view' ? 'here menu-here-bg' : '' }}">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('permissions.view') }}">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                                        <span class="svg-icon svg-icon-3">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
