        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{ Route::currentRouteName() == 'dashboard' ? 'here' : '' }}">
                    <div class="menu-item">
                        <!--begin:Menu link-->
                ...
                <!--end:Menu item-->
                <div data-kt-menu-trigger="click" class="menu-item {{ Route::currentRouteName() == 'roles.view' ? 'show hover' : '' }} {{ Route::currentRouteName() ==  'permissions.view' ? 'here show' : ''}} menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion {{ Route::currentRouteName() ==  'roles.view' ? 'here show' : ''}}"
                        ...
                        <div class="menu-item">
                            ...
                            <a class="menu-link {{ Route::currentRouteName() == 'roles.view' ? 'active' : '' }}" href="{{ route('roles.view') }}">
                        ...
                        <div class="menu-item">
                            ...
                            <a class="menu-link {{ Route::currentRouteName() == 'permissions.view' ? 'active' : '' }}" href="{{ route('permissions.view') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div class="menu-item pt-5">
                    ...
                    <div class="menu-content">
                        <span class="menu-heading text-uppercase">Pages</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <!--end:Menu item-->
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="multi-steps-sign-up.html">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="add-contact.html">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="edit-contact.html">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="User-Management-list.html">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="invoice-1.html">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
