            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_account_profile_details_form" class="form" action="{{ route('user.change-password') }}" method="POST">
                            @csrf
                            <!--begin::Card body-->
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        ...
                                        @error('current_password')
                                            <x-input-label for="current_password" :value="$message"></x-input-label>
                                        @enderror
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                 ...
                                 <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        ...
                                        @error('new_password')
                                            <x-input-label for="new_password" :value="$message"></x-input-label>
                                        @enderror
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                 ...
                                 <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                        <span class="required">Comfirm Password</span>
                                    </label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input class="form-control form-control-lg form-control-solid" placeholder="New Password Confirmation" name="new_password_confirmation" type="password" autocomplete="off"/>
                                        @error('new_password_confirmation')
                                            <x-input-label for="new_password_confirmation" :value="$message"></x-input-label>
                                        @enderror
                                    </div>
                                    <!--end::Col-->
                                </div>
