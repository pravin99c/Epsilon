                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-12">
                                ...
                                <div class="row">
                                 ...
                                 <!--end::Separator-->
                                <form action="{{ route('users.create') }}" id="users_add_form" method="POST">
                                    @csrf
                                    <div class="row mb-6">
                                        <!--begin::Label-->
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                    <input type="text" name="first_name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="First name" value="{{ old('first_name') }}">
                                                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                                                <!--end::Col-->
                                                <!--begin::Col-->
                                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                    <input type="text" name="last_name" class="form-control form-control-lg form-control-solid" placeholder="Last name" value="{{ old('last_name') }}">
                                                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Row-->
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-10 fv-row fv-plugins-icon-container">
                                            <input type="password" name="password" class="form-control form-control-lg form-control-solid" placeholder="Enter Password" id="password" value="">
                                        <div class="fv-plugins-message-container invalid-feedback"></div></div>
                                        <!--end::Col-->
                                    </div>
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-10 fv-row fv-plugins-icon-container">
                                            <input type="password" name="password_confirmation" class="form-control form-control-lg form-control-solid" placeholder="Confirm Password" value="">
                                        <div class="fv-plugins-message-container invalid-feedback"></div></div>
                                        <!--end::Col-->
                                    </div>
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-10 fv-row fv-plugins-icon-container">
                                            <input type="tel" name="phone_number" class="form-control form-control-lg form-control-solid" placeholder="Phone Number" value="{{ old('phone_number') }}">
                                        <div class="fv-plugins-message-container invalid-feedback"></div></div>
                                        <!--end::Col-->
                                    </div>
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-10 fv-row">
                                            <div class="position-relative d-flex align-items-center">
                                                ...
                                                <!--end::Svg Icon-->
                                                <input class="form-control form-control-solid ps-12 flatpickr-input active" name="dob" placeholder="Pick a date" id="date_of_birth" type="text" readonly="readonly" value="{{ old('dob') }}">
                                                @error('dob')
...
@section('script')
<script src="{{ asset('assets/js/users/add_validation.js') }}"></script>
<script>
