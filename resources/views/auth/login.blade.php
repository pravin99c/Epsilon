                ...
                <div class="w-lg-500px p-10">
                    ...
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="{{ route('login') }}" method="POST">
                        ...
                        <div class="fv-row mb-8">
                            ...
                            @error('email')
                                <x-input-label for="email" :value="$message"> </x-input-label>
                            @enderror
                            <!--end::Email-->
                        </div>
                        <!--end::Input group=-->
                        <div class="fv-row mb-3">
                            ...
                            @error('password')
                                <x-input-label for="password" :value="$message"> </x-input-label>
                            @enderror
                            <!--end::Password-->
                        </div>
                        <!--end::Input group=-->
                        ...
                        <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                            <div></div>
                            <!--begin::Link-->
                            <a href="{{ route('password_forgot') }}" class="link-primary">Forgot Password ?</a>
                            <!--end::Link-->
                        </div>
                        <!--end::Wrapper-->
                        <!--begin::Submit button-->
