...
Change password request send successfully.
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <a class="" href="" style="mso-line-height-rule:
                                                        exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
                                                        #f57153; font-weight: normal; text-decoration: none" target="_blank" title="">
                                                    <img align="center" alt="Forgot your password?" class="mcnImage" src="https://blog.hubspot.com/hubfs/image8-2.jpg" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: collapse; mso-table-lspace: 0;
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <a class="mcnButton " href="@isset($url){{ $url }}@endisset" style="mso-line-height-rule: exactly;
